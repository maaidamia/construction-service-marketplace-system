        ...
        <div class="row py-20 py-xl-80">
            <div class="col-12 col-xl-4 footer-widget about">
                <div class="footer-brand">
                    <img src="{{asset('front')}}/assets/logo-footer.svg" alt="logo" />
                </div>
                ...
                <ul class="social-btn-group mt-34">
                    <li class="social-item">
                        <a class="social-link" href="#">
                            <img src="{{asset('front')}}/assets/icons/facebook-f.svg" class="svg-inject svg-icon" alt="" />
                        </a>
                    </li>
                    <li class="social-item">
                        <a class="social-link" href="#">
                            <img src="{{asset('front')}}/assets/icons/twitter.svg" class="svg-inject svg-icon" alt="" />
                        </a>
                    </li>
                    <li class="social-item">
                        <a class="social-link" href="#">
                            <img src="{{asset('front')}}/assets/icons/youtube.svg" class="svg-inject svg-icon" alt="" />
                        </a>
                    </li>
                    <li class="social-item">
                        <a class="social-link" href="#">
                            <img src="{{asset('front')}}/assets/icons/linkedin.svg" class="svg-inject svg-icon" alt="" />
                        </a>
                    </li>
                    <li class="social-item">
                        <a class="social-link" href="#">
                            <img src="{{asset('front')}}/assets/icons/instagram.svg" class="svg-inject svg-icon" alt="" />
                        </a>
                    </li>
                </ul>
            ...
            <div class="col-12 col-xl-3 footer-widget link-list _icon mt-34 mt-xl-0">
                ...
                <ul class="footer-link-list _icon">
                    <li class="link-item">
                        <img src="{{asset('front')}}/assets/icons/mark-stroke.svg" class="svg-inject svg-icon" alt="" />
                        <a class="link" href="#">
                            <span>832 Thompson Drive, San Fransisco CA 94107, United States</span>
                        </a>
                    </li>
                    <li class="link-item">
                        <img src="{{asset('front')}}/assets/icons/phone-stroke.svg" class="svg-inject svg-icon" alt="" />
                        <a class="link" href="#">
                            <span>+123 345123 556</span>
                        </a>
                    </li>
                    <li class="link-item">
                        <img src="{{asset('front')}}/assets/icons/envelope-stroke.svg" class="svg-inject svg-icon" alt="" />
                        <a class="link" href="#">
