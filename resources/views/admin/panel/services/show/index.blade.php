                            ...
                            <div class="card-body">
                                <form action="{{ route('sp.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="basic-addon-name" class="form-control" placeholder="Service Name" name="name" value="{{ $sp->ser_data1 }}">
                                    </div>
                                    <div class="mb-1">
                                        ...
                                        <select class="form-select" id="select-country1" name="category">
                                            ...
                                            <option value="{{$i->id}}" {{ $i->id == $sp->ser_data2 ? 'selected' : '' }}>{{$i->scat_data1}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-1">
