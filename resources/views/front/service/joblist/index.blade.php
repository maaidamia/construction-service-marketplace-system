...
<div class="container-xxl">
    <div class="row">
        <div class="col-12 col-lg-6 my-34 my-lg-80 my-xl-120 my-xxl-180 order-2 order-lg-1">
            <h1 class="heading-header-1 mb-0">Find a service provider through <span class="text-primary">CSMS</span> easily</h1>
            <!-- /.heading-header -->

            <form class="ms-auto mt-60" role="search" action="#" method="get">
                <div class="form-btn-inner shadow-2 rounded-pill">
                    <input class="form-control" type="search" placeholder="Search here..." />
                    <button class="btn btn-primary fw-semiBold py-12 px-20 px-lg-34 flex-nofill shadow-none" type="submit">Search Services</button>
                </div>
            </form>
            <!-- /.search-job-form -->

            <div class="d-flex flex-wrap justify-content-center justify-content-lg-start mt-34 gap-12">
                <a href="#" class="btn btn-suggestion fw-medium rounded-pill shadow-none">Plumbing</a>
                <a href="#" class="btn btn-suggestion fw-medium rounded-pill shadow-none">Piping</a>
                <a href="#" class="btn btn-suggestion fw-medium rounded-pill shadow-none">Electrical</a>
                <a href="#" class="btn btn-suggestion fw-medium rounded-pill shadow-none">Air Conditioning</a>
                <a href="#" class="d-none d-md-inline-block btn btn-suggestion fw-medium rounded-pill shadow-none">Metal Fabrication</a>
                <a href="#" class="d-none d-md-inline-block btn btn-suggestion fw-medium rounded-pill shadow-none">Joinery</a>
                <a href="#" class="d-none d-md-inline-blockbtn btn-suggestion fw-medium rounded-pill shadow-none">Flooring</a>
                <a href="#" class="d-none d-md-inline-block btn btn-suggestion fw-medium rounded-pill shadow-none">Wood Works</a>
        ...
        <div class="col-12 col-lg-6 order-1 order-lg-2">
            <div class="position-relative h-lg-100">
                <img src="{{asset('front/assets/pages/joblist/header/Under_construction-rafiki.png')}}" class="hero-image-img" alt="" />
            </div>
        </div>
        <!-- /.col -->
    </div>
...
<div class="container-xxl">
    <div class="d-flex flex-column flex-xl-row align-items-xl-center gap-20">
        <h4 class="heading-section-4 text-dark mb-0">Showing {{count($sps)}} Companies</h4>
        <!-- /.heading-section -->
        ...
        <div class="job-card-harizontal">
            ...
            <div class="job-info">
                ...
                <div class="job-info-inner">
                    <h5 class="job-title">
                        <a href="{{route('front.service.show', $i->id)}}">{{$i->bdCorporate->bdcor_data1}}</a>
                    </h5>
                    <div class="job-author">
                        <a href="{{route('front.service.show', $i->id)}}">{{$i->bdCorporate->bdcor_data9}}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="job-action">
                <a class="btn btn-apply flex-fill flex-md-nofill fw-semiBold py-12 px-43 rounded-pill" href="{{route('front.service.show', $i->id)}}">See more</a>
