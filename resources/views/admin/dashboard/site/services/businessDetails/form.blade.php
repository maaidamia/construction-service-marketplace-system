...
<div class="app-content content ">
    ...
    <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="#">
                                        {{ Request::is('business-details/corporate') ? 'Corporate Details' : '' }}
                                        {{ Request::is('business-details/contact') ? 'Contact Details' : '' }}
                                    </a>
                                </li>
                            </ol>
                        </div>
        ...
        <div class="content-body">
            ...
            @if (Request::is('business-details'))
            @include('admin.dashboard.site.services.businessDetails.dashboard.index')
            @endif
            @if (Request::is('business-details/corporate'))
            @include('admin.dashboard.site.services.businessDetails.corporate.index')
            @endif
            @if (Request::is('business-details/contact'))
            @include('admin.dashboard.site.services.businessDetails.contact.index')
            @endif
            @if (Request::is('business-details/document'))
            @include('admin.dashboard.site.services.businessDetails.document.index')
            @endif
