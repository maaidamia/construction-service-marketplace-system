                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="last-name-column" class="form-control" placeholder="Last Name" name="email">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="first-name-column">Password</label>
                                                <input type="password" id="first-name-column" class="form-control" placeholder="Password" name="password">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select" id="basicSelect" name="role">
                                                    ...
                                                    @foreach ($roles as $i)
                                                        <option value="{{ $i->name }}" {{ $i->name == 'superadministrator' ? 'hidden' : '' }}>{{$i->display_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
